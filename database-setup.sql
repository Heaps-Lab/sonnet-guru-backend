-- ============================================
-- LMS Platform - Complete Database Setup
...
-- ============================================
-- Create migrations table (for TypeORM tracking)
-- ============================================
...
VALUES (
  ...
  '$2b$10$rZ3PqhJvQ7YZ0qXqXqXqXeK8K8K8K8K8K8K8K8K8K8K8K8K8K8K8K8',
  'Super Admin',
  TRUE,
  '[]'
);
...
UNION ALL
SELECT 'payment_claims', COUNT(*) FROM payment_claims
UNION ALL
